...
CREATE TABLE `music_share`  (
  ...
  `sender_id` int NOT NULL COMMENT '分享者用户ID',
  `receiver_id` int NOT NULL COMMENT '接收者用户ID',
  `song_id` int NOT NULL COMMENT '分享的音乐ID',
  `cur_status` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'PENDING' COMMENT 'PENDING=未处理, STORED=留存, DROPPED=丢弃',
  `content_text` varchar(648) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '留言',
...
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '音乐村帖子表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '音乐村帖子评论表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 55 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '音乐村帖子点赞记录表' ROW_FORMAT = DYNAMIC;
